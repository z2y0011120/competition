                ...
                if (valid) {
                    ...
                    res.then(result => {
                        ...
                        if (result.success) {
                            ...
                            const aa = {name5:userinfo.userName}
                            sessionStorage.setItem("name5",JSON.stringify(aa))
                            console.log(aa)
                            if(aa.name5=="zhangyaoyao@qq.com"){
                                that.$router.push('/home');
                            }else if (aa.name5=="zhangzhangyao@qq.com"){
                                that.$router.push('/admin/student');
                            }else{
                                that.$router.push('/home');
                            }
